...
- At a high level, do you think this post is worth including on my blog? Will it impress employers at all? I am not so sure - it seems perhaps a bit too easy/basic
- Are there some things you think are unnecessary? Some examples that come to my mind:
  - Some of the explanation of apgo. Should I just refer the reader to the paper?
  - The code for my ModelWrapper. Just link to my github?
- Should I remove my claims that we are gaining an understanding of how language works?
- I was also able to successfully apply it to a language model, but I do not think the results are too interesting so I did not include them. They just indicate how some words translate into others. For example, when translating "il y a trois hommes" to "there are three men", the set {"il", "y", "a"} is most important for predicting "there". Do you think it is worth including these results?
